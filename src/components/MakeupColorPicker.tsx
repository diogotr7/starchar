...
export function MakeupColorPicker() {
      ...
      <Group>
        <Stack>
          <SmallColorInput
            ...
            onChange={(c) => {
              updateCharacter((d) => {
                d.faceMaterial.faceColors.eyeMakeupColor1 = c;
              });
            }}
          />
          <SmallColorInput
            ...
            onChange={(c) => {
              updateCharacter((d) => {
                d.faceMaterial.faceColors.eyeMakeupColor2 = c;
              });
            }}
          />
          <SmallColorInput
            ...
            onChange={(c) => {
              updateCharacter((d) => {
                d.faceMaterial.faceColors.eyeMakeupColor3 = c;
              });
            }}
          />
        </Stack>
        <Stack>
          <SmallColorInput
            ...
            onChange={(c) => {
              updateCharacter((d) => {
                d.faceMaterial.faceColors.cheekMakeupColor1 = c;
              });
            }}
          />
          <SmallColorInput
            ...
            onChange={(c) => {
              updateCharacter((d) => {
                d.faceMaterial.faceColors.cheekMakeupColor2 = c;
              });
            }}
          />
          <SmallColorInput
            ...
            onChange={(c) => {
              updateCharacter((d) => {
                d.faceMaterial.faceColors.cheekMakeupColor3 = c;
              });
            }}
          />
        </Stack>
        <Stack>
          <SmallColorInput
            ...
            onChange={(c) => {
              updateCharacter((d) => {
                d.faceMaterial.faceColors.lipMakeupColor1 = c;
              });
            }}
          />
          <SmallColorInput
            ...
            onChange={(c) => {
              updateCharacter((d) => {
                d.faceMaterial.faceColors.lipMakeupColor2 = c;
              });
            }}
          />
          <SmallColorInput
            ...
            onChange={(c) => {
              updateCharacter((d) => {
                d.faceMaterial.faceColors.lipMakeupColor3 = c;
              });
            }}
          />
        </Stack>
