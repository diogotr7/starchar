...
export function readFaceMaterial(reader: BufferReader, headMaterialType: HeadMaterialType): FaceMaterial {
  // weird special case.
  reader.expectUint32(headMaterialType === "HeadMaterialF11" ? 0xa5378a05 : 0x72129e8e);
...
export function writeFaceMaterial(writer: BufferWriter, faceMaterial: FaceMaterial, headMaterialType: HeadMaterialType) {
  writer.writeUint32(headMaterialType === "HeadMaterialF11" ? 0xa5378a05 : 0x72129e8e);
