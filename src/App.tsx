...
export function App() {
  ...
  }, [chf, resetCharacter, loadCharacter]);
      ...
      <AppShell.Header>
        <SimpleGrid cols={3} m="sm">
          <Group>
            {isMobile ? (
              <>
                <ActionIcon component="a" target="_blank" rel="noopener noreferrer" href="https://github.com/diogotr7/starchar" variant="subtle">
                  <IconBrandGithub size={32} />
                </ActionIcon>
                <ActionIcon component="a" target="_blank" rel="noopener noreferrer" href="https://paypal.me/diogotr7" variant="subtle">
              ...
              <>
                ...
                <ActionIcon size="lg" onClick={toggleColorScheme} variant="outline">
          ...
          <Group justify="space-evenly">
            ...
            <FileInput ml="auto" w={isMobile ? "100%" : "auto"} clearable={true} accept=".chf" placeholder="Upload Chf" value={chf} onChange={setChf} />
          </Group>
        </SimpleGrid>
      </AppShell.Header>
      <AppShell.Main>
        <Stack gap="md" justify="center">
          {isCharacterLoaded ? <CharacterEditor /> : <DropzoneChf onDrop={setChf} />}
        </Stack>
      </AppShell.Main>
    </AppShell>
  );
